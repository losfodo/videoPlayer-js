  ...
  return (
    <Menu autoSelect={false} placement="top-start">
      ...
      >
        ...
        >{/*titulo*/}
          {[0.3, 0.5, 1, 1.3, 1.5, 1.8, 2].map((rate) => (//variação de velocidade modificada aqui
            <MenuItem
              height="40px"
              ...
              onClick={() => {
                ...
                setPlaybackRate(rate);//setPlaybackRate: Permite definir a velocidade de reprodução da animação de uma entidade
              }}
              rounded="8px"
              _hover={{
                bg: "rgba(0, 0, 0, 0.4)"
